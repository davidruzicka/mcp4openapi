...
### Added
- Added repository-scoped autonomous-agent docs plus tested evaluator/reviewer automation helpers for feedback follow-ups, current-head review selection, reviewer lease comments, and GitHub Actions workflows.
