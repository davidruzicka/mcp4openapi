...
### Added
- Added profile-driven MCP Apps support with `resources/list`, `resources/templates/list`, `resources/read`, template completion, and tool/resource Apps metadata validation/composition.
