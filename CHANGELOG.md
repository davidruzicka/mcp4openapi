...
### Added
- Added repository-scoped autonomous-agent docs plus tested evaluator/reviewer automation helpers for feedback follow-ups, current-head review selection, reviewer lease comments, bounded semantic review publication, and GitHub Actions workflows.
