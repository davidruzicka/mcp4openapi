...
- Tunables: `MCP4_CONSENT_APPROVAL_TTL_MS` (default 5 minutes) bounds approval-token lifetime; `MCP4_CONSENT_CONSUMED_MAX` (default 10000) bounds the per-instance consumed-approval replay guard.
