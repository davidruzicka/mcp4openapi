...
- [x] **Timeout Enforcement**: Compile regex with implicit timeout (use safe-regex or similar library to detect dangerous patterns).
...
- [x] **Integrate in `src/profile-loader.ts`**:
